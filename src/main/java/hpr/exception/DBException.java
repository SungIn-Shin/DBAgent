...
public class DBException extends Exception {
	public static enum Code { SUCCESS, CONNECTION_FAIL, TABLE_NOT_EXIST, DUPLICATED_ROW, UNKOWN_ERROR};
...
//				return Code.TABLE_NOT_EXIST;
	...
	// 	try {
	// 		try {
	// 			throw new SQLException(new SQLException("i don't know", "What? SQLState", 1));
	// 		}
	// 		catch( Exception ex) {
