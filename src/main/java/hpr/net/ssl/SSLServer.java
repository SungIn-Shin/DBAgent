...
//	private char[] passPhrase;
	...
	private ByteBuffer recvDecryptedBuffer_;
	private ByteBuffer recvEncryptedBuffer_;
...
//			this.passPhrase = passPhrase;
			...
			recvDecryptedBuffer_ = ByteBuffer.allocate(this.getAppBufferSize());
			recvEncryptedBuffer_ = ByteBuffer.allocate(this.getAppBufferSize());
		}
		catch(IOException e)
		{
	...
	public synchronized ByteBuffer decryptForRead(ByteBuffer buffer) throws Exception {
		inAppBuffer.clear();
	...
	public ByteBuffer getRecvEncryptedBuffer() throws Exception {
		return recvEncryptedBuffer_;
	}
